...
CREATE TABLE "jadlospis" (
	...
	"id_kuchni" SMALLINT,
	-- do ktorego dnia obowiazuje jadlospis
	"do_kiedy_obowiazuje" DATE,
	"id_firmy" SMALLINT,
	PRIMARY KEY("id_jadlospisu")
);
COMMENT ON COLUMN jadlospis.do_kiedy_obowiazuje IS 'do ktorego dnia obowiazuje jadlospis';
...
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "firmy_zewnetrzne"
ADD FOREIGN KEY("id_oferty") REFERENCES "oferta_firmy_zewnetrznej"("id_oferty")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "oferta_firmy_zewnetrznej"
ADD FOREIGN KEY("id_produktu") REFERENCES "produkt"("id_produktu")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "jadlospis"
ADD FOREIGN KEY("id_firmy") REFERENCES "firmy_zewnetrzne"("id_firmy")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "zamowienie"
ADD FOREIGN KEY("id_uzytkownika") REFERENCES "uzytkownicy"("id_uzytkownika")
ON UPDATE NO ACTION ON DELETE NO ACTION;